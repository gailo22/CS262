...
def bleensome(str):
    ...
    bleen = []
    for word in words:
        bleen = bleen + re.findall(r'.*b.*t.*|.*t.*g.*',word)
    return bleen
        # write your code here 

def gruesome(str):
    return re.findall(r"""[a-zA-Z]*b[a-zA-Z]*t[a-zA-Z]*|[a-zA-Z]*t[a-zA-Z]*g[a-zA-Z]*""", str)
...
print bleensome(test1) == answer1
print bleensome(test2) == ['but', 'Baronetage', 'contemplating']
print bleensome(test3) == ['everything']
print bleensome(test4) == ['wombats', 'abating']
