...
<ul>
  ...
  <li> There are also ordered lists that used (OL) tags. Let's make one nested inside our current list item.
    <ol>
      <li>Text can be <strong>strong (STRONG)</strong> or <em>emphasized (EM)</em>, which typically renders like bold \r\n and italics.</li>
...
<p>We'll finish off with one last paragraph.
</p>
</html> 
"""
